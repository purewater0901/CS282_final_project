...
wht = load(
    name="wht",
    sources=["/home/yutaka/CS282_final_project/src/deep_learning/fwh_cpp.cpp", 
             "/home/yutaka/CS282_final_project/src/deep_learning/fwh_cu.cu"],
    verbose=True
)
...
class IntrinsicSAIDFT(FullFT):
    def __init__(
        ...
        **kwargs
        ...
        intrinsic_dim = kwargs['intrinsic_dim'] # Try different values like 100, 500, 1000
        IntrinsicDimensionLight.apply(
            module=self.model,
